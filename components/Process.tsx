...
export default function Process() {
  ...
  const steps = [
    {
      num: 1,
      title: "الدراسة والتشخيص",
      desc: "فحص وتقييم الوضع المحاسبي الراهن للمنشأة ورصد الثغرات ونقاط الضعف المالية الهيكلية.",
    },
    {
      num: 2,
      title: "التنظيم وبناء الهيكل",
      desc: "تصميم شجرة الحسابات وتأسيس الدورة المستندية والبرمجية الملائمة لحجم وأهداف المنشأة.",
    },
    {
      num: 3,
      title: "المتابعة والتنفيذ الدوري",
      desc: "تسجيل القيود وتدقيق المستندات بشكل دوري مستمر لضمان دقة وتطابق الحسابات بصورة منتظمة.",
    },
    {
      num: 4,
      title: "الحوكمة والتحليل الاستراتيجي",
      desc: "استخراج القوائم وتقديم القراءات المالية الاستشارية لدعم قرارات التنمية وتفادي المخاطر.",
    },
  ];
